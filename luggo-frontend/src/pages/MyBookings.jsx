...
export default function MyBookings() {
  ...
  // ✅ Remove confirmed bookings that already have an active session
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {activeSessions.length === 0 ? (
              ...
              if (remainingMs > 0) {
                ...
                remainingText = `${hrs}h ${mins}m ${secs}s left`;
              } else {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-sm mt-2">
                    <Calendar size={16} className="inline mr-2" /> {s.start_time.substring(0, 10)}
                  </p>
                  <p className="text-sm">
                    <Clock size={16} className="inline mr-2" /> 
                    {s.start_time.substring(11,16)} → {s.end_time.substring(11,16)}
                  </p>
                  ...
                  <button
                    ...
                    className="mt-4 w-full py-2 rounded-lg flex justify-center items-center gap-2 
                               text-white font-semibold
                               bg-gradient-to-r from-green-500 to-green-600 
                               hover:from-green-600 hover:to-green-700
                               shadow-lg shadow-green-300/50
                               animate-[pulse_1.6s_infinite]"
                  >
